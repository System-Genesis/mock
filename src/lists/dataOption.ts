...
export default {
  ...
  ROOT_HIERARCHY: ['armagadon', 'bladerunners', 'interstellar', 'odyssey'] as const,
  CITY_MAIL: 'turtleS.com',

  ID_PREFIXES_WEIGHT: [8, 1, 1, 2, 1, 1, 1, 1, 1, 1, 3, 1, 1],
  ID_PREFIXES: ['e', 'ee', 'e8e', 'g', 'gf', 'g5f', 'l', 'j', 'i', 'ii'] as const,
  ID_PREFIXES_GU: ['m', 'mads', 'madNN'] as const,
  ID_PREFIXES_GU_WEIGHT: [1, 1, 1],
};
